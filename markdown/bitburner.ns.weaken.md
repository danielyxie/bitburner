...
Use your hacking skills to attack a server’s security, lowering the server’s security level. The runtime for this command depends on your hacking level and the target server’s security level when the function is called. This function lowers the security level of the target server by 0.05.
