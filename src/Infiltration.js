...
function nextInfiltrationLevel(inst) {
    ...
    writeInfiltrationStatusText("You are now on clearance <span class='hacker-green'>level " + inst.clearanceLevel + "</span>.<br>" +
                                scenario);
}
...
function updateInfiltrationLevelText(inst) {
    ...
    document.getElementById("infiltration-level-text").innerHTML =
        ...
        "Clearance Level: <span class='hacker-green'>" + inst.clearanceLevel + "</span><br>" +
        ...
        "Total monetary value of secrets stolen: <span class='money-gold'>$" + formatNumber(totalMoneyValue, 2) + "</span><br><br>" +
        "Hack exp gained: <span class='hacker-green'>" + formatNumber(inst.hackingExpGained * expMultiplier, 3) + "</span><br>" +
        "Str exp gained:  <span class='physical-yellow'>" + formatNumber(inst.strExpGained * expMultiplier, 3) + "</span><br>" +
        "Def exp gained:  <span class='physical-yellow'>" + formatNumber(inst.defExpGained * expMultiplier, 3) + "</span><br>" +
        "Dex exp gained:  <span class='physical-yellow'>" + formatNumber(inst.dexExpGained * expMultiplier, 3) + "</span><br>" +
        "Agi exp gained:  <span class='physical-yellow'>" + formatNumber(inst.agiExpGained * expMultiplier, 3) + "</span><br>" +
        "Cha exp gained:  <span class='charisma-purple'>" + formatNumber(inst.chaExpGained * expMultiplier, 3) + "</span>";
}
