    ...
    <>
      <p className="tooltip" style={{ display: "inline-block" }}>
        ...
        <span className="tooltiptext">
          Represents the amount of respect your gang has from other gangs and
          criminal organizations. Your respect affects the amount of money your
          gang members will earn, and also determines how much reputation you
          are earning with your gang's corresponding Faction.
        </span>
      </p>
      <br />
      <p className="tooltip" style={{ display: "inline-block" }}>
        ...
        <span className="tooltiptext">
          Represents how much the gang is wanted by law enforcement. The higher
          your gang's wanted level, the harder it will be for your gang members
          to make money and earn respect. Note that the minimum wanted level is
          1.
        </span>
      </p>
      <br />
      <p className="tooltip" style={{ display: "inline-block" }}>
        ...
        {formatNumber((1 - props.gang.getWantedPenalty()) * 100, 2)}%
        <span className="tooltiptext">
      ...
      <p style={{ display: "inline-block" }}>
        Faction reputation:{" "}
        {Reputation(Factions[props.gang.facName].playerReputation)}
      </p>
      <br />
