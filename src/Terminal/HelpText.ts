...
export const TerminalHelpText: string[] = [
  ...
  "ls [dir] [-l] [--grep pattern]            Displays all files on the machine",
...
export const HelpTexts: IMap<string[]> = {
  ...
  ls: [
    ...
    " ",
    "List all files in a single-column list format:",
    " ",
    "ls -l"
  ],
  ...
  "scan-analyze": [
    ...
    "'scan-analyze 1' will display inflagsformation for the same servers that are shown by the 'scan' Terminal ",
