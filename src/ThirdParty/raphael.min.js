        ...
        void 0 ===
          (n = function (t) {
            ...
            (e._getContainer = function (t, r, i, n) {
              ...
              if (
                (a =
                  n != null || e.is(t, "object")
                    ? t
                    : l.doc.getElementById(t)) != null
              )
                return a.tagName
                  ? r == null
                    ? {
            ...
            (Yt.animateWith = function (t, r, i, n, a, s) {
              ...
              (Yt.setTime = function (t, e) {
                return (
                  t && e != null && this.status(t, k(e, t.ms) / t.ms), this
                );
              }),
                ...
                if ((e.is(a, "string") && (a = this.getFont(a)), a)) {
                  ...
                  for (
                    var y = a.face.bbox[v](n),
                      ...
                      _ = 0,
                      B =
                        +y[1] + (o == "baseline" ? b + +a.face.descent : b / 2),
                      C = 0,
                      S = c.length;
                    C < S;
                    C++
          ...
          (n = function (t) {
            if (!t || t.svg) {
              ...
              var x = function (i, n) {
                ...
                y = function (t) {
                  if ((e = document.documentMode) && (e === 9 || e === 10))
                    return "url('#" + t + "')";
                  var e,
                    r = document.location;
                  return (
