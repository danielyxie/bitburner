...
export function getCostOfNextHacknetNode() {
    ...
    const numOwned = Player.hacknetNodes.length;
    const mult = HacknetNodeConstants.PurchaseNextMult;

    return HacknetNodeConstants.BaseCost * Math.pow(mult, numOwned) * Player.hacknet_node_purchase_cost_mult;
}

export function getCostOfNextHacknetServer() {
    const numOwned = Player.hacknetNodes.length;
    const mult = HacknetServerConstants.PurchaseMult;

    if (numOwned >= HacknetServerConstants.MaxServers) { return Infinity; }

    return HacknetServerConstants.BaseCost * Math.pow(mult, numOwned) * Player.hacknet_node_purchase_cost_mult;
}
