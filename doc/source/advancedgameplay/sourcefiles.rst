...
||                                    || * Level 3 grants permanent access to use the `Warehouse API <https://github.com/danielyxie/bitburner/blob/dev/markdown/bitburner.warehouseapi.md>`_ and `Office API <https://github.com/danielyxie/bitburner/blob/dev/markdown/bitburner.officeapi.md>`_ |
+-------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
